...
## Obtiene los ejes del input mediante operaciónes aritméticas simples.
...
## Obtiene un número flotante aleatoreo usando [method RandomNumberGenerator.randomize] y 
